...
parallel_improve:
	python src/parallel_cube_rl.py --mode improve --levels $(l) --min_rate $(r) --batch_size $(batch_size) --use_pregenerated --target_rate 100 --processes $(p) --recent_window $(w) --memory_size $(memory_size) --gamma $(gamma) --lr $(lr) --epsilon_min $(epsilon_min) --plat $(plat)
